...
def list_ollama_models():
    try:
        ...
        data = response.model_dump()  # Pydantic v2+ compatible

        print("🔍 Raw model data from ollama.list():")
        print(json.dumps(data, indent=2, default=json_serial))  # Handle datetime
